...
{
    [SerializeField]
    private BotTextToSpeechScript tts; // IBM Watson Text to Speech gameobject
    [SerializeField]
    private BotSpeechToTextScript stt; // IBM Watson Speech to Text gameobject
    [SerializeField]
    ...
    void Update()
    {
        ...
        if (stt.ServiceReady())
        {
            ...
            {
                // While Bot Speaks
                UIManagerScript.instance.audioListingBtn.SetActive(false);
                stt.Active = false;
            }
            else
            {
                //While Bot Listine
                UIManagerScript.instance.audioListingBtn.SetActive(true);
                stt.Active = true;
            }
        }
